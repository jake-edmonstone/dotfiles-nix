...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VICMD_CONTENT_EXPANSION='%Bλ%b'
  # Prompt symbol in visual vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIVIS_CONTENT_EXPANSION='%Bλ%b'
  # Prompt symbol in overwrite vi mode.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIOWR_CONTENT_EXPANSION='%Bλ%b'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#bd93f9'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#bd93f9'
  # Display anchor directory segments in bold.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_BOLD=true
  # Make entire directory bold.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%F{#ff79c6}'  # Dracula pink
      local   modified='%255F'        # white (xterm 255)
      local  untracked='%218F'        # light pink (xterm 218)
      local conflicted='%F{#f1fa8c}'  # Dracula yellow
      local    stashed='%F{#8be9fd}'  # Dracula cyan
      local     remote='%F{#50fa7b}'  # Dracula green
    else
      ...
      local     remote='%244F'  # grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND='#50FA7B'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#50FA7B'
  # Custom icon.
  ...
  # Context color (overridden by template escapes below).
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND='#ff5555'
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND='#8be9fd'
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    # to match your needs. Customize them as needed.
      '*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND='#ffb86c'
